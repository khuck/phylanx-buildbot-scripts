...
export papi_path=/usr/local/packages/papi/5.7.0
#export boost_path=${basedir}/buildbot/build-${myarch}/boost-1.69.0
export boost_path=/usr/local/packages/boost/1.69.0
